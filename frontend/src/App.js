...
const PageLoader = () => (
  <div className="flex h-screen w-full items-center justify-center bg-gray-50">
    <div className="text-center">
      <Loader className="mx-auto mb-4 h-10 w-10 animate-spin text-[#1e3a5f]" />
      <p className="font-medium text-gray-500">Laden...</p>
    </div>
  </div>
)
          ...
          <BrowserRouter>
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route
                  path="/angebote"
                  element={<SpecialProductsPage title="Aktuelle Angebote" type="offers" />}
                />
                <Route
                  path="/neuheiten"
                  element={<SpecialProductsPage title="Neuheiten" type="new" />}
                />
                <Route
                  path="/bestseller"
                  element={<SpecialProductsPage title="Bestseller" type="bestseller" />}
                />
