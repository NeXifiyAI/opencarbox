  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        ...
        <h1 className="mb-8 text-3xl font-bold text-[#1e3a5f]">Kontakt</h1>

        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          {/* Contact Form */}
          <div className="rounded-lg bg-white p-8 shadow-sm">
            <h2 className="mb-6 text-xl font-semibold text-[#1e3a5f]">Schreiben Sie uns</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-[#4fd1c5] font-bold text-[#1e3a5f] hover:bg-[#38b2ac]"
              >
                Nachricht senden
              </Button>
            </form>
          ...
          <div className="space-y-6">
            <div className="rounded-lg bg-white p-8 shadow-sm">
              <h2 className="mb-6 text-xl font-semibold text-[#1e3a5f]">Kontaktdaten</h2>
              <ul className="space-y-6">
                <li className="flex gap-4">
                  <div className="h-fit rounded-full bg-blue-50 p-3 text-[#1e3a5f]">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">Mo-Fr: 08:00 - 18:00 Uhr</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <div className="h-fit rounded-full bg-blue-50 p-3 text-[#1e3a5f]">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Wir antworten i.d.R. innerhalb von 24h
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
            ...
            <div className="rounded-lg bg-[#1e3a5f] p-8 text-white shadow-sm">
