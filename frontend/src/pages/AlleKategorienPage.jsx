  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        ...
        <h1 className="mb-8 text-3xl font-bold text-[#1e3a5f]">Alle Kategorien</h1>
                  ...
                  {cat.subcategories.map((sub) => (
                    <li key={sub.id}>
                      <Link
                        ...
                        className="group flex items-center justify-between text-sm text-gray-600 hover:text-[#4fd1c5]"
                      >
                        <span>{sub.name}</span>
