  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12">
        ...
        <h1 className="mb-8 text-3xl font-bold text-[#1e3a5f]">Allgemeine Geschäftsbedingungen</h1>

        <div className="space-y-8 rounded-lg bg-white p-8 shadow-sm">
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#1e3a5f]">§ 1 Geltungsbereich</h2>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#1e3a5f]">§ 2 Vertragsschluss</h2>
            <p className="text-gray-600">
              Die Darstellung der Produkte im Online-Shop stellt kein rechtlich bindendes Angebot,
              sondern eine Aufforderung zur Abgabe einer Bestellung dar. Mit dem Absenden der
              Bestellung geben Sie ein verbindliches Angebot ab. Der Kaufvertrag kommt zustande,
              wenn wir Ihre Bestellung durch eine Auftragsbestätigung per E-Mail bestätigen.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              Zusätzlich anfallende Versandkosten werden im jeweiligen Angebot gesondert
              ausgewiesen.
            </p>
          </section>

          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#1e3a5f]">§ 4 Lieferung</h2>
            <p className="text-gray-600">
              Die Lieferung erfolgt an die vom Kunden angegebene Lieferadresse. Die Lieferzeit
              beträgt in der Regel 1-3 Werktage nach Zahlungseingang. Bei Lieferverzögerungen werden
              wir Sie unverzüglich informieren.
            </p>
          </section>

          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#1e3a5f]">§ 5 Widerrufsrecht</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#1e3a5f]">§ 6 Gewährleistung</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#1e3a5f]">§ 7 Schlussbestimmungen</h2>
            <p className="text-gray-600">
          ...
          <p className="border-t pt-4 text-sm text-gray-500">Stand: Januar 2025</p>
        </div>
      </main>
      <Footer />
    </div>
