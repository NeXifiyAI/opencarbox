  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        carvantooo:
          'border-transparent bg-carvantooo-100 text-carvantooo-800 hover:bg-carvantooo-200',
        opencarbox:
          'border-transparent bg-opencarbox-100 text-opencarbox-800 hover:bg-opencarbox-200',
